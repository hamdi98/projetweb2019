...
<!-- script-for sticky-nav -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><b><center>Ajouter promotion</b></center></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="col-md-8">
    <div class="form-group">
          ...
          <label class="control-label change-label"> Solde * 
            <input name="solde" type="number" min="5" max="99" class="form-control"required>
              <br>
            ID_Promo *
            <input name="id_promo" min="1" type="number" class="form-control" id="id_promo"  required>
...
<?php $b = date("Y-m-d");?>
   ...
   <br> Date_debut *
          <input class="form-control" type="date" min="<?php echo $a?>"  name="date_debut" required> 
        </span><br>
		Date_fin *
            <input name="date_fin" type="date" min="<?php echo $b ?>"  class="form-control"   required> 			
 ...
 <div class="form-group"><div class="row"><div class="col-sm-6"></div></div></div>
	
    <div class="form-group ct-u-paddingTop20">
      <button type="submit" onclick="CalculSolde();" class="btn btn-danger" name="ajouter" >
        Ajouter <i class="fa fa-long-arrow-right fa-fw"></i>
      </button>
    </div>
