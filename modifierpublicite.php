...
{
	if (!empty($_POST['id_pub']) and !empty($_POST['commentaire']) and !empty($_POST['image']))
{
       $publicite=new publicite($_POST['id_pub'],$_POST['commentaire'],$_POST['image']);
       $publiciteC=new PubliciteC;
       $publiciteC->modifierPublicite($publicite);
...
<div class="col-md-8">
    <div class="form-group">
          ...
          <label class="control-label change-label">           ID Publicité *
            <input name="id_pub" type="number" class="form-control" id="id_pub"  required>
  ...
  <br>  Commentaire *
  <input name="commentaire" type="text" class="form-control"  required>
        <br>
		</label>	
      </div></div>
