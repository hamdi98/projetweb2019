                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <form action="Ajoutercard.php" method="POST">
                                        <?php $emailll=$_SESSION['mail'];   ?>
                                    <div class="Sign-in-up-bt" style="position:absolute; right: auto; left: 406px; bottom:-83px;">
                                        <input type="hidden" name="email" value="<?PHP echo $emailll;?>">
                                        <p>want a fidelity card?  <a href="Ajoutercard.php" name="yes" value="yes">yes!</a>, <a href="info.php">info</a>. </p>
                                    </div></form>
                                </div>
                            </div>
                        </div>
