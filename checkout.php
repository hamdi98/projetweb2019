...
<body>
    ...
    <div id="wrapper">
                            ...
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="header-right-side-menu ml-15">
                                     ...
                                     <div class="Sign-in-up-bt" style="position:absolute; right: auto; left: 406px; bottom:-57px;">
                                     <p>Hello, <a href="Profile.php?email=<?PHP echo $emaill; ?>"><?php echo $name;?></a> , <a href="Logout.php">Logout</a></p>

                                    </div>
                                        
                                    <div class="Sign-in-up-bt" style="position:absolute; right: auto; left: 406px; bottom:-83px;">
                                    
                                    <p>your points:  <a href="#"> <?php echo $pointss; ?> </a>, <a href="#">info</a>. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="checkout_area section_padding_100">
         ...
         <button  onclick="Signup()" value="modifier" name="modifier" id="submit-form-button" class="btn" type="submit" style="width: 400px; background-color: #ff084e;" > Change </button>
         <input type="hidden" name="email_ini" value="<?PHP echo $emaill;?>">
